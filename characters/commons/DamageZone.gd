"""
Manages damage on a character.
When touched, a knockback force is applied to the character.
"""
extends Area2D
...
"""
Applies knockback on character
"""
...
"""
Damage amount for the hit character.
"""
